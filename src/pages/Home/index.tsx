...
export default function HomePage() {
  ...
  const panelClass =
    "flex min-h-0 flex-col rounded-[2rem] border border-white/10 bg-[#0a0d10]/95 p-6 shadow-2xl shadow-black/25";

  return (
    <div className="mx-auto flex w-full max-w-[1200px] flex-1 flex-col px-5 py-4 sm:px-6 lg:px-8">
      <div className="border-b border-white/[0.07] pb-4">
        <h1 className="text-[34px] font-semibold tracking-[-0.03em] text-text">Home</h1>
      </div>

      <section className="mt-4 grid gap-6 lg:grid-cols-2 lg:auto-rows-fr">
        ...
        <div className={panelClass}>
          ...
          {latestPost ? (
            <div className="mt-5 flex flex-1 flex-col border-t border-white/[0.07] pt-5">
